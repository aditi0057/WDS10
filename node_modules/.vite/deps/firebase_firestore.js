...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  static p() {
    ...
    if (___PRIVATE_SimpleDb.S()) return true;
    const e = getUA(), t = ___PRIVATE_SimpleDb.D(e), n = 0 < t && t < 10, r = __PRIVATE_getAndroidVersion(e), i = 0 < r && r < 4.5;
  ...
  async M(e) {
    return this.db || (__PRIVATE_logDebug("SimpleDb", "Opening database:", this.name), this.db = await new Promise((t, n) => {
      ...
      r.onsuccess = (e2) => {
        ...
        this.F.O(t2, r.transaction, e2.oldVersion, this.version).next(() => {
...
var __PRIVATE_IterationController = class {
  constructor(e) {
    this.L = e, this.k = false, this.q = null;
  }
  get isDone() {
    return this.k;
  }
...
var __PRIVATE_WatchChangeAggregator = class {
  constructor(e) {
    ...
    this.Le = /* @__PURE__ */ new Map(), /** Keeps track of the documents to update since the last raised snapshot. */
   ...
   */
  forEachTarget(e, t) {
    e.targetIds.length > 0 ? e.targetIds.forEach(t) : this.Le.forEach((e2, n) => {
      this.je(n) && t(n);
    });
  }
  /**
...
function __PRIVATE_fromDbMutationBatch(e, t) {
  ...
  const r = t.mutations.map((t2) => __PRIVATE_fromMutation(e.ht, t2)), i = Timestamp.fromMillis(t.localWriteTimeMs);
...
var __PRIVATE_IndexedDbGlobalsCache = class {
  ...
  getSessionToken(e) {
    return this.It(e).get("sessionToken").next((e2) => {
...
var __PRIVATE_OrderedCodeWriter = class {
  ...
  qt(e) {
    for (const t of e) {
      const e2 = t.charCodeAt(0);
      if (e2 < 128) this.Bt(e2);
      else if (e2 < 2048) this.Bt(960 | e2 >>> 6), this.Bt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t) this.Bt(480 | e2 >>> 12), this.Bt(128 | 63 & e2 >>> 6), this.Bt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
        this.Bt(240 | e3 >>> 18), this.Bt(128 | 63 & e3 >>> 12), this.Bt(128 | 63 & e3 >>> 6), this.Bt(128 | 63 & e3);
      }
    }
    this.Lt();
  }
...
var __PRIVATE_TargetIndexMatcher = class {
  constructor(e) {
    this.tn = new SortedSet((e2, t) => FieldPath$1.comparator(e2.field, t.field)), this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.nn = e.orderBy, this.rn = [];
    for (const t of e.filters) {
      const e2 = t;
      e2.isInequality() ? this.tn = this.tn.add(e2) : this.rn.push(e2);
    }
  }
  get sn() {
   ...
   */
  on(e) {
    if (__PRIVATE_hardAssert(e.collectionGroup === this.collectionId), this.sn)
      return false;
    const t = __PRIVATE_fieldIndexGetArraySegment(e);
    if (void 0 !== t && !this._n(t)) return false;
    ...
    if (this.tn.size > 0) {
      const e2 = this.tn.getIterator().getNext();
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.an(e2, t2) || !this.un(this.nn[s++], t2)) return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.nn.length || !this.un(this.nn[s++], e2)) return false;
    }
    return true;
  }
  /**
  ...
  _n(e) {
    for (const t of this.rn) if (this.an(t, e)) return true;
    return false;
  }
  an(e, t) {
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
     ...
     */
    this.Pn = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  /**
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.Tn(t), (t2) => this.getIndexType(e, t2).next((n) => {
      if (0 === n || 1 === n) {
        const n2 = new __PRIVATE_TargetIndexMatcher(t2).cn();
  ...
  getDocumentsMatchingTarget(e, t) {
    ...
    return PersistencePromise.forEach(this.Tn(t), (t2) => this.In(e, t2).next((e2) => {
      r && (r = !!e2), i.set(t2, e2);
    })).next(() => {
      if (r) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return new Bound(n2, r3);
          }(s, i2), c = this.dn(i2, s, a), l = this.dn(i2, s, u), h = this.En(i2, s, _), P = this.An(i2.indexId, o, c, a.inclusive, l, u.inclusive, h);
  ...
  An(e, t, n, r, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Rn(t[c / a]) : Ae, l = this.Vn(e, _2, n[c % a], r), h = this.mn(e, _2, i[c % a], s), P = o.map((t2) => this.Vn(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  In(e, t) {
    ...
    return this.getFieldIndexes(e, r).next((e2) => {
      let t2 = null;
      for (const r2 of e2) {
        n.on(r2) && (!t2 || r2.fields.length > t2.fields.length) && (t2 = r2);
      }
      return t2;
    });
  }
  getIndexType(e, t) {
    let n = 2;
    const r = this.Tn(t);
    return PersistencePromise.forEach(r, (t2) => this.In(e, t2).next((e2) => {
  ...
  fn(e, t) {
    ...
    for (const r of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      const i = n.Xt(r.kind);
      __PRIVATE_FirestoreIndexValueWriter.Ft.dt(e2, i);
    }
    return n.Ht();
  }
  ...
  Rn(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.Ft.dt(e, t.Xt(
      0
      /* IndexKind.ASCENDING */
    )), t.Ht();
  }
  ...
  gn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.Ft.dt(__PRIVATE_refValue(this.databaseId, t), n.Xt(function __PRIVATE_fieldIndexGetKeyOrder(e2) {
  ...
  En(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r) if (this.pn(t, s.fieldPath) && isArray(e2)) r = this.yn(r, s, e2);
      else {
        const t2 = n2.Xt(s.kind);
        __PRIVATE_FirestoreIndexValueWriter.Ft.dt(e2, t2);
      }
    }
    return this.wn(r);
  }
  ...
  yn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || []) for (const n2 of r) {
      ...
      r2.seed(n2.Ht()), __PRIVATE_FirestoreIndexValueWriter.Ft.dt(e2, r2.Xt(t.kind)), i.push(r2);
    }
    return i;
  }
  pn(e, t) {
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.Sn(e).next((e2) => r.U("collectionGroupIndex", IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.uid, e2, n)))));
  }
  updateIndexEntries(e, t) {
    const n = /* @__PURE__ */ new Map();
    return PersistencePromise.forEach(t, (t2, r) => {
      const i = n.get(t2.collectionGroup);
      return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t2.collectionGroup)).next((i2) => (n.set(t2.collectionGroup, i2), PersistencePromise.forEach(i2, (n2) => this.bn(e, t2, n2).next((t3) => {
        const i3 = this.Dn(r, n2);
        return t3.isEqual(i3) ? PersistencePromise.resolve() : this.vn(e, r, n2, t3, i3);
      }))));
    });
  }
  Cn(e, t, n, r) {
  ...
  Dn(e, t) {
    ...
    if (null != i) {
      ...
      if (isArray(s)) for (const i2 of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Rn(i2), r));
  ...
  vn(e, t, n, r, i) {
    ...
    return function __PRIVATE_diffSortedSets(e2, t2, n2, r2, i2) {
      ...
      /* onAdd= */
      (r2) => {
        s.push(this.Cn(e, t, n, r2));
      },
      /* onRemove= */
      (r2) => {
        s.push(this.Fn(e, t, n, r2));
      }
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.Tn(t), (t2) => this.In(e, t2).next((e2) => e2 || fail())).next(__PRIVATE_getMinOffsetFromFieldIndexes);
  }
};
  ...
  addMutationBatch(e, t, n, r) {
    ...
    return s.add({}).next((o) => {
      ...
      const _ = new MutationBatch(o, t, n, r), a = function __PRIVATE_toDbMutationBatch(e2, t2, n2) {
        const r2 = n2.baseMutations.map((t3) => toMutation(e2.ht, t3)), i2 = n2.mutations.map((t3) => toMutation(e2.ht, t3));
        return {
          userId: t2,
          batchId: n2.batchId,
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  removeTargetData(e, t) {
    return this.removeMatchingKeysForTargetId(e, t.targetId).next(() => __PRIVATE_targetsStore(e).delete(t.targetId)).next(() => this.Kn(e)).next((t2) => (__PRIVATE_hardAssert(t2.targetCount > 0), t2.targetCount -= 1, this.$n(e, t2)));
  }
  /**
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  getEntries(e, t) {
    ...
    return this.ur(e, t, (e2, t2) => {
      const r = this._r(e2, t2);
      n = n.insert(e2, r);
    }).next(() => n);
  }
  /**
  ...
  getDocumentsMatchingQuery(e, t, n, r, i) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).U(IDBKeyRange.bound(o, _, true)).next((e2) => {
      ...
      for (const i2 of e2) {
        const e3 = this._r(DocumentKey.fromSegments(i2.prefixPath.concat(i2.collectionGroup, i2.documentId)), i2);
  ...
  getAllFromCollectionGroup(e, t, n, r) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).J({
      ...
      const s2 = this._r(DocumentKey.fromSegments(t2.prefixPath.concat(t2.collectionGroup, t2.documentId)), t2);
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  ...
  constructor(e, t) {
    ...
    // this buffer.
    this.Pr = new ObjectMap((e2) => e2.toString(), (e2, t2) => e2.isEqual(t2));
  }
  applyChanges(e) {
    const t = [];
    ...
    return this.changes.forEach((i, s) => {
      ...
      if (t.push(this.hr.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
        ...
        const n2 = __PRIVATE_toDbRemoteDocument(this.hr.serializer, s.convertToNoDocument(SnapshotVersion.min()));
        t.push(this.hr.addEntry(e, i, n2));
      }
    }), r.forEach((n2) => {
      t.push(this.hr.indexManager.addToCollectionParentIndex(e, n2));
    }), t.push(this.hr.updateMetadata(e, n)), PersistencePromise.waitFor(t);
  }
  getFromCache(e, t) {
    return this.hr.ar(e, t).next((e2) => (this.Pr.set(t, {
      size: e2.size,
      readTime: e2.document.readTime
    }), e2.document));
  }
  getAllFromCache(e, t) {
    return this.hr.cr(e, t).next(({ documents: e2, lr: t2 }) => (
...
var __PRIVATE_MemoryTargetCache = class {
  ...
  removeTargets(e, t, n) {
    ...
    return this.Lr.forEach((s, o) => {
      o.sequenceNumber <= t && null === n.get(o.targetId) && (this.Lr.delete(s), i.push(this.removeMatchingKeysForTargetId(e, o.targetId)), r++);
...
var __PRIVATE_MemoryLruDelegate = class ___PRIVATE_MemoryLruDelegate {
  ...
  removeOrphanedDocuments(e, t) {
    ...
    return r.Br(e, (r2) => this.ir(e, r2, t).next((e2) => {
...
var __PRIVATE_SchemaConverter = class {
  ...
  O(e, t, n, r) {
    ...
    })), n < 5 && r >= 5 && (s = s.next(() => this.ii(i))), n < 6 && r >= 6 && (s = s.next(() => (function __PRIVATE_createDocumentGlobalStore(e2) {
    ...
    }(e)).next(() => this.ui(e, i)).next(() => e.deleteObjectStore("remoteDocuments"))), n < 14 && r >= 14 && (s = s.next(() => this.ci(e, i))), n < 15 && r >= 15 && (s = s.next(() => function __PRIVATE_createFieldIndex(e2) {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.li = i, this.window = s, this.document = o, this.hi = a, this.Pi = u, this.Ti = c, this.$r = null, this.Ur = false, this.isPrimary = false, this.networkEnabled = true, /** Our window.unload handler, if registered. */
    this.Ii = null, this.inForeground = false, /** Our 'visibilitychange' listener if registered. */
    this.di = null, /** The client metadata refresh task. */
    this.Ei = null, /** The last time we garbage collected the client metadata object store. */
    this.Ai = Number.NEGATIVE_INFINITY, /** A listener to notify on primary state changes. */
    this.Ri = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.p()) throw new FirestoreError(D.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r), this.Vi = t + "main", this.serializer = new __PRIVATE_LocalSerializer(_), this.mi = new __PRIVATE_SimpleDb(this.Vi, this.Ti, new __PRIVATE_SchemaConverter(this.serializer)), this.Wr = new __PRIVATE_IndexedDbGlobalsCache(), this.Gr = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.jr = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.fi = this.window.localStorage : (this.fi = null, false === u && __PRIVATE_logError("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  /**
  ...
  gi() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (this.isPrimary) return this.bi(e).next((e2) => {
        e2 || (this.isPrimary = false, this.li.enqueueRetryable(() => this.Ri(false)));
      });
    }).next(() => this.Di(e)).next((t) => this.isPrimary && !t ? this.vi(e).next(() => false) : !!t && this.Ci(e).next(() => true))).catch((e) => {
  ...
  bi(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => PersistencePromise.resolve(this.Fi(e2)));
  }
  Mi(e) {
  ...
  async xi() {
    if (this.isPrimary && !this.Oi(this.Ai, 18e5)) {
      ...
      const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (e2) => {
        ...
        return t.U().next((e3) => {
          const n = this.Ni(e3, 18e5), r = e3.filter((e4) => -1 === n.indexOf(e4));
   ...
   */
  wi() {
    this.Ei = this.li.enqueueAfterDelay("client_metadata_refresh", 4e3, () => this.gi().then(() => this.xi()).then(() => this.wi()));
  }
  ...
  Di(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get("owner").next((t) => {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).U().next((e2) => void 0 === this.Ni(e2, 5e3).find((e3) => {
  ...
  async shutdown() {
    this.Ur = false, this.ki(), this.Ei && (this.Ei.cancel(), this.Ei = null), this.qi(), this.Qi(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
    // has obtained the primary lease.
    await this.mi.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
   ...
   */
  Ni(e, t) {
    return e.filter((e2) => this.Oi(e2.updateTimeMs, t) && !this.Li(e2.clientId));
  }
  /**
   ...
   */
  $i() {
    return this.runTransaction("getActiveClients", "readonly", (e) => __PRIVATE_clientMetadataStore(e).U().next((e2) => this.Ni(e2, 18e5).map((e3) => e3.clientId)));
  }
  get started() {
    return this.Ur;
  }
  ...
  runTransaction(e, t, n) {
    ...
    let s;
    return this.mi.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.$r ? this.$r.next() : __PRIVATE_ListenSequence.oe), "readwrite-primary" === t ? this.bi(s).next((e2) => !!e2 || this.Di(s)).next((t2) => {
      if (!t2) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.li.enqueueRetryable(() => this.Ri(false)), new FirestoreError(D.FAILED_PRECONDITION, C);
      return n(s);
    }).next((e2) => this.Ci(s).next(() => e2)) : this.Ui(s).next(() => n(s)))).then((e2) => (s.raiseOnCommittedEvent(), e2));
  }
  /**
  ...
  Ui(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Oi(e2.leaseTimestampMs, 5e3) && !this.Li(e2.ownerId) && !this.Fi(e2) && !(this.Pi || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(D.FAILED_PRECONDITION, Ve);
    });
  }
  /**
  ...
  vi(e) {
    ...
    return t.get("owner").next((e2) => this.Fi(e2) ? (__PRIVATE_logDebug("IndexedDbPersistence", "Releasing primary lease."), t.delete("owner")) : PersistencePromise.resolve());
  }
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
  ...
  return i ? Promise.resolve(i.target) : n.persistence.runTransaction("Get target data", "readonly", (e2) => r.ut(e2, t).next((e3) => e3 ? e3.target : null));
}
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  const n = __PRIVATE_debugCast(e), r = n.ls.get(t) || SnapshotVersion.min();
  return n.persistence.runTransaction("Get new document changes", "readonly", (e2) => n.hs.getAllFromCollectionGroup(
    e2,
    t,
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
  ...
  for (const e2 of n) {
    const n2 = t.As(e2.metadata.name);
    e2.document && (s = s.add(n2));
    const r2 = t.Rs(e2);
    r2.setReadTime(t.Vs(e2.metadata.readTime)), o = o.insert(n2, r2);
  }
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (e2) => __PRIVATE_populateDocumentChangeBuffer(e2, _, o).next((t2) => (_.apply(e2), t2)).next((t2) => i.Gr.removeMatchingKeysForTargetId(e2, a.targetId).next(() => i.Gr.addMatchingKeys(e2, s, a.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(e2, t2.Is, t2.ds)).next(() => t2.Is)));
}
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0) return i.jr.saveNamedQuery(e2, t);
    const o = r.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
    return i.us = i.us.insert(o.targetId, o), i.Gr.updateTargetData(e2, o).next(() => i.Gr.removeMatchingKeysForTargetId(e2, r.targetId)).next(() => i.Gr.addMatchingKeys(e2, n, r.targetId)).next(() => i.jr.saveNamedQuery(e2, t));
  });
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.li = t, this.persistenceKey = n, this.ws = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Ss = this.bs.bind(this), this.Ds = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.vs = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Cs = createWebStorageClientStateKey(this.persistenceKey, this.ws), this.Fs = /** Assembles the key for the current sequence number. */
    function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.Ds = this.Ds.insert(this.ws, new __PRIVATE_LocalClientState()), this.Ms = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.xs = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.Os = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.Ns = /** Assembles the key for the online state of the primary tab. */
    function createWebStorageOnlineStateKey(e2) {
      return `firestore_online_state_${e2}`;
    }(this.persistenceKey), this.Bs = function createBundleLoadedKey(e2) {
  ...
  async start() {
    ...
    for (const e2 of this.vs) this.bs(e2);
  ...
  addLocalQueryTarget(e, t = true) {
    ...
    if (this.isActiveQueryTarget(e)) {
      ...
      if (t2) {
        const r = __PRIVATE_QueryTargetMetadata.fs(e, t2);
        r && (n = r.state);
      }
    }
  ...
  shutdown() {
    this.started && (this.window.removeEventListener("storage", this.Ss), this.removeItem(this.Cs), this.started = false);
  }
  getItem(e) {
        ...
        if (this.started) {
          if (null !== t.key) {
            if (this.Ms.test(t.key)) {
              if (null == t.newValue) {
                const e2 = this.js(t.key);
                return this.Hs(e2, null);
              }
              {
                const e2 = this.Js(t.key, t.newValue);
                if (e2) return this.Hs(e2.clientId, e2);
              }
              ...
              if (null !== t.newValue) {
                const e2 = this.Xs(t.key, t.newValue);
                if (e2) return this.eo(e2);
              }
            } else if (t.key === this.Ns) {
              if (null !== t.newValue) {
                const e2 = this.ks(t.newValue);
                if (e2) return this.qs(e2);
              }
              ...
              const e2 = this.no(t.newValue);
              await Promise.all(e2.map((e3) => this.syncEngine.ro(e3)));
            }
          }
        } else this.vs.push(t);
      });
...
class __PRIVATE_RestConnection {
  ...
  Oo(e, t, n, r, i) {
    ...
    return this.Bo(_, r, i), this.Lo(e, o, _, n).then((t2) => (__PRIVATE_logDebug("RestConnection", `Received RPC '${e}' ${s}: `, t2), t2), (t2) => {
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.L_.has(t.targetId) || // Mark this as something the client is currently listening for.
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.L_.delete(t), r.s_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.L_.size && (r.s_() ? r.a_() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
    ...
    try {
      ...
      async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r of t2.targetIds)
          e2.L_.has(r) && (await e2.remoteSyncer.rejectListen(r, n2), e2.L_.delete(r), e2.U_.removeTarget(r));
      }(e, t);
    } catch (n2) {
    ...
    function __PRIVATE_raiseWatchSnapshot(e2, t3) {
      ...
      return n2.targetChanges.forEach((n3, r) => {
        if (n3.resumeToken.approximateByteSize() > 0) {
          const i = e2.L_.get(r);
          i && e2.L_.set(r, i.withResumeToken(n3.resumeToken, t3));
        }
      }), // Re-establish listens for the targets that have been invalidated by
      // existence filter mismatches.
      n2.targetMismatches.forEach((t4, n3) => {
        const r = e2.L_.get(t4);
        if (!r)
          return;
        e2.L_.set(t4, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.k_.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  ...
  await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      ...
      const n = e2.B_.shift();
      __PRIVATE_ensureWriteStream(e2).__(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.K_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ), await n.remoteSyncer.handleCredentialChange(t), n.k_.delete(
    3
    /* OfflineCause.CredentialChange */
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.W_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.W_.__(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.K_.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (await e.W_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.W_;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.G_ || // Create stream (but note that it is not started yet).
  (e.G_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r = __PRIVATE_debugCast(e2);
    ...
    await __PRIVATE_fillWritePipeline(e)) : (await e.G_.stop(), e.B_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.B_.length} pending writes`), e.B_ = []));
  })), e.G_;
}
...
var __PRIVATE_BundleConverterImpl = class {
   ...
   */
  Rs(e) {
    return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, false) : MutableDocument.newNoDocument(this.As(e.metadata.name), this.Vs(e.metadata.readTime));
  }
  Vs(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.ha = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.Ea = t, this.Aa = null, this.hasCachedResults = false, /**
   ...
   */
  Da(e) {
    return !this.Ea.has(e) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.Ua = (t2, n2, r2) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
  ...
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s.Es), _ = o.ga(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* limboResolutionEnabled= */
    e.isPrimaryClient,
    a
  ...
  try {
    const e2 = await function __PRIVATE_localStoreWriteLocally(e3, t2) {
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (e4) => {
        let _ = __PRIVATE_mutableDocumentMap(), a = __PRIVATE_documentKeySet();
        return n2.hs.getEntries(e4, i).next((e5) => {
    ...
    r.sharedClientState.addPendingMutation(e2.batchId), function __PRIVATE_addMutationCallback(e3, t2, n2) {
      let r2 = e3.qa[e3.currentUser.toKey()];
      r2 || (r2 = new SortedMap(__PRIVATE_primitiveComparator));
      r2 = r2.insert(t2, n2), e3.qa[e3.currentUser.toKey()] = r2;
...
function __PRIVATE_processUserCallback(e, t, n) {
  ...
  if (i) {
    const e2 = i.get(t);
    e2 && (n ? e2.reject(n) : e2.resolve(), i = i.remove(t)), r.qa[r.currentUser.toKey()] = i;
  }
}
...
function __PRIVATE_removeLimboTarget(e, t) {
  ...
  const n = e.Ba.get(t);
  null !== n && (__PRIVATE_remoteStoreUnlisten(e.remoteStore, n), e.Ba = e.Ba.remove(t), e.La.delete(n), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.Ba.get(n) || e.Na.has(r) || (__PRIVATE_logDebug("SyncEngine", "New document in limbo: " + n), e.Na.add(r), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.Na.size > 0 && e.Ba.size < e.maxConcurrentLimboResolutions; ) {
    ...
    e.La.set(r, new LimboResolution(n)), e.Ba = e.Ba.insert(n, r), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.oe));
  }
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  const i = __PRIVATE_debugCast(e), s = await function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
    ...
    return n2.persistence.runTransaction("Lookup mutation documents", "readonly", (e3) => r2.On(e3, t2).next((t3) => t3 ? n2.localDocuments.getDocuments(e3, t3) : PersistencePromise.resolve(null)));
  }(i.localStore, t);
  null !== s ? ("pending" === n ? (
    ...
    (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e2, t2) {
      __PRIVATE_debugCast(__PRIVATE_debugCast(e2).mutationQueue).Bn(t2);
    }(i.localStore, t))
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.$a) {
    ...
    n.$a = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2) __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.$a) {
    const e2 = [];
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.ka.wr(), t3.La = /* @__PURE__ */ new Map(), t3.Ba = new SortedMap(DocumentKey.comparator);
    }(n), n.$a = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r.Oa.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r.xa.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
...
function __PRIVATE_syncEngineGetActiveClients(e) {
  return function __PRIVATE_localStoreGetActiveClients(e2) {
    return __PRIVATE_debugCast(__PRIVATE_debugCast(e2).persistence).$i();
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.$a) {
    for (const e2 of t) {
      if (r.Oa.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
    ...
    for (const e2 of n)
      r.Oa.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        /* keepPersistedTargetData */
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      if (await function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("hasNewerBundle", "readonly", (e4) => n3.jr.getBundleMetadata(e4, t3.id)).then((e4) => !!e4 && e4.createTime.compareTo(r3) >= 0);
      ...
      let s = await t2.Ga();
      for (; s; ) {
        const e3 = await i.Pa(s);
        e3 && n2._updateProgress(e3), s = await t2.Ga();
      }
      ...
      await function __PRIVATE_localStoreSaveBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("Save bundle", "readwrite", (e4) => n3.jr.saveBundleMetadata(e4, t3));
      }(e2.localStore, r2), n2._completeWith(o.progress), Promise.resolve(o.Ia);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Za = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.kind = "persistent", this.synchronizeTabs = false;
  }
  async initialize(e) {
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Za = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    // set it after localStore / remoteStore are started.
    await this.persistence.Si(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Za.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  za(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.tu = e, this.serializer = t, /** Cached bundle metadata. */
    ...
    this.ru().then((e2) => {
      e2 && e2.la() ? this.metadata.resolve(e2.ca.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.ca)}`));
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, i = await n.ko("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
      i.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.uu = n.maxAttempts, this.r_ = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
...
function __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(e, t, n = {}) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_readDocumentViaSnapshotListener(e2, t2, n2, r2, i) {
    const s = new __PRIVATE_AsyncObserver({
      next: (_) => {
        s.eu(), t2.enqueueAndForget(() => __PRIVATE_eventManagerUnlisten(e2, o));
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r.Es), s = i.ga(r.documents), o = i.applyChanges(
        s,
        /* limboResolutionEnabled= */
        false
      );
  ...
  return e.asyncQueue.enqueueAndForget(async () => {
    try {
      ...
      r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
        var r2;
        const i2 = __PRIVATE_debugCast(e2), { request: s, lt: o, parent: _ } = __PRIVATE_toRunAggregationQueryRequest(i2.serializer, __PRIVATE_queryToAggregateTarget(t2), n2);
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).X_.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
  }(await __PRIVATE_getEventManager(e), n)), () => {
    n.eu(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).X_.delete(t2);
    }(await __PRIVATE_getEventManager(e), n));
  };
}
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
  return e.asyncQueue.enqueue(async () => function __PRIVATE_localStoreGetNamedQuery(e2, t2) {
    ...
    return n.persistence.runTransaction("Get named query", "readonly", (e3) => n.jr.getNamedQuery(e3, t2));
...
function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
  return e.asyncQueue.enqueue(async () => function __PRIVATE_localStoreSetIndexAutoCreationEnabled(e2, t2) {
    __PRIVATE_debugCast(e2)._s.Hi = t2;
  }(await __PRIVATE_getLocalStore(e), t));
}
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  qu(e) {
    return __PRIVATE_createError(e, this.settings.methodName, this.settings.Qu || false, this.path, this.settings.Ku);
  }
...
function __PRIVATE_parseSetData(e, t, n, r, i, s = {}) {
  const o = e.$u(s.merge || s.mergeFields ? 2 : 0, t, n, i);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Mu) throw 1 === e.Mu ? e.qu(`${this._methodName}() can only appear at the top level of your update data`) : e.qu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Uu.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayUnionTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.Uu, e.Uu);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Uu.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.Uu, e.Uu);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.Wu === e.Wu;
  }
};
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r, i, s) {
  const o = e.$u(1, t, n), _ = [__PRIVATE_fieldPathFromArgument$1(t, r, n)], a = [i];
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Mu)) throw t2.qu(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path) throw t2.qu(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.Nu && 4 !== t.Mu) throw t.qu("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n)) throw t2.qu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
              ...
              value: {
                arrayValue: {
                  values: e3.toArray().map((e4) => {
                    if ("number" != typeof e4) throw t3.qu("VectorValues must only contain numeric values.");
    ...
    throw t2.qu(`Unsupported field value: ${__PRIVATE_valueDescription(e2)}`);
  }(e, t);
}
function __PRIVATE_parseObject(e, t) {
  ...
  return isEmpty(e) ? (
    ...
    const i = __PRIVATE_parseData(r, t.Ou(e2));
    null != i && (n[e2] = i);
  }), {
    mapValue: {
      fields: n
...
function runTransaction(e, t, n) {
  ...
  return function __PRIVATE_firestoreClientTransaction(e2, t2, n2) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => {
      ...
      new __PRIVATE_TransactionRunner(e2.asyncQueue, i, n2, t2, r2).cu();
    }), r2.promise;
